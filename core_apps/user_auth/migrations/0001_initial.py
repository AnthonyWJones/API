# Generated by Django 5.0.13 on 2025-03-22 03:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_question', models.CharField(choices=[('maiden_name', "What is your mother's maiden name?"), ('favorite_color', 'What is your favorite color?'), ('birth_city', 'What is the name of the city you were born in?'), ('childhood_friend', 'What is the name of your childhood best friend?')], max_length=30, verbose_name='Security Question')),
                ...
                ('id_no', models.PositiveIntegerField(db_index=True, unique=True, verbose_name='ID No')),
